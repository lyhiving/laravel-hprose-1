...
PHP="/usr/bin/php"
#项目目录
WWWROOT="/Users/zhiqiang/workspace/blog"
SCRIPT="artisan"
SERVICE_NAME="hprose:socket"
PID="${WWWROOT}/vendor/whereof/laravel-hprose/${SERVICE_NAME}.pid"
LOG="${WWWROOT}/vendor/whereof/laravel-hprose/${SERVICE_NAME}.log"
